    ...
    <div className="min-h-screen bg-[#f8fafc] flex">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          {/* WELCOME SECTION */}
          <div className="mb-10">
            <h1 className="text-3xl font-bold text-gray-900 mb-2 italic tracking-tighter uppercase">Shipment Overview</h1>
            <p className="text-gray-500 font-medium italic">Your logistical footprint, synchronized and simplified.</p>
          </div>
