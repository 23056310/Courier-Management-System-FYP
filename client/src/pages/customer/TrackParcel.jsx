        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar">
          <div className="max-w-5xl mx-auto">
            <div className="mb-8 sm:mb-10">
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 italic">Track Your Parcel</h1>
              <p className="text-gray-500 font-medium text-sm">Enter your tracking ID to get real-time shipment updates.</p>
            </div>

            {/* SEARCH */}
            <div className="relative mb-8 sm:mb-12 group">
              <div className="absolute inset-x-0 -bottom-2 h-full bg-primary/10 rounded-[2rem] sm:rounded-[2.5rem] blur-xl opacity-50 group-hover:opacity-100 transition-opacity" />
              <div className="relative flex flex-col sm:flex-row p-2 sm:p-3 bg-white rounded-3xl sm:rounded-[2.5rem] border border-gray-100 shadow-xl items-center gap-2">
                <div className="flex items-center w-full grow">
                  <HiOutlineSearch className="ml-4 sm:ml-6 text-xl sm:text-2xl text-gray-400 shrink-0" />
                  <input
                    type="text"
                    ...
                    className="w-full px-4 sm:px-6 py-4 sm:py-5 focus:outline-none font-bold text-gray-900 text-sm placeholder:font-medium placeholder:text-gray-400"
                  />
                  {trackingId && (
                ...
                <button
                  onClick={handleTrack}
                  disabled={isLoading}
                  className="w-full sm:w-auto bg-gray-900 text-white px-8 sm:px-10 py-4 sm:py-5 rounded-2xl sm:rounded-[2rem] font-black uppercase tracking-[0.2em] text-[10px] hover:bg-primary transition-all disabled:opacity-50 flex items-center justify-center gap-2 group/btn whitespace-nowrap"
                >
            ...
            {/* NOT FOUND */}
            {notFound && (
              <div className="py-16 sm:py-20 text-center bg-white rounded-3xl sm:rounded-[2.5rem] border border-red-100 border-dashed p-8">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-6">
                  <HiOutlineX className="text-2xl sm:text-3xl text-red-400" />
                </div>
            ...
            {!result && !notFound && !isLoading && (
              <div className="py-20 sm:py-24 text-center bg-white rounded-3xl sm:rounded-[2.5rem] border border-gray-100 border-dashed p-8">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-6">
                  <HiOutlineSearch className="text-2xl sm:text-3xl text-gray-300" />
                </div>
            ...
            {result && (
              <div>
                ...
                {/* TIMELINE */}
                <div className="bg-white rounded-3xl sm:rounded-[2.5rem] border border-gray-100 p-6 sm:p-10 md:p-14 shadow-sm relative overflow-hidden">
                  <div className="relative z-10">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 sm:mb-16 gap-4">
                      <h3 className="text-xl sm:text-2xl font-black italic text-gray-900 uppercase tracking-tighter">Shipment Journey</h3>
                    ...
                    <div className="relative">
                      ...
                      <div className="relative flex flex-col md:flex-row justify-between gap-8 md:gap-4 lg:gap-10">
                        {STATUS_STEPS.map((step, idx) => {
                          const done = idx <= currentStepIndex;
                          const active = idx === currentStepIndex;
                          return (
                            <div key={step} className="relative z-10 flex md:flex-col items-center md:items-center gap-6 md:gap-5 md:text-center shrink-0">
                              <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center text-xl transition-all duration-500 shrink-0 ${
                                done
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 sm:p-8 bg-white rounded-3xl sm:rounded-[2rem] border border-gray-100 shadow-sm">
                  ...
                  <div className="p-6 sm:p-8 bg-gray-900 rounded-3xl sm:rounded-[2rem] flex flex-col justify-center items-center text-center gap-4">
                    <p className="text-gray-400 text-sm font-bold italic">Need help with this shipment?</p>
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500">Our support team is here 24/7</p>
                    <Link to="/contact" className="w-full">
                      <button className="w-full px-8 py-4 bg-primary text-white rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] hover:bg-white hover:text-primary transition-all">
                        Send Inquiry
                      </button>
                    </Link>
                  </div>
